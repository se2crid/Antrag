...
enum IdeviceErrorCode os_trace_relay_connect_tcp(struct TcpProviderHandle *provider,
                                                 struct OsTraceRelayClientHandle **client);

void os_trace_relay_free(struct OsTraceRelayClientHandle *handle);

enum IdeviceErrorCode os_trace_relay_start_trace(struct OsTraceRelayClientHandle *client,
                                                 struct OsTraceRelayReceiverHandle **receiver,
                                                 const uint32_t *pid);

void os_trace_relay_receiver_free(struct OsTraceRelayReceiverHandle *handle);

enum IdeviceErrorCode os_trace_relay_get_pid_list(struct OsTraceRelayClientHandle *client,
                                                  struct Vec_u64 **list);

enum IdeviceErrorCode os_trace_relay_next(struct OsTraceRelayReceiverHandle *client,
 ...
 * `client` must be a valid, non-null pointer to a location where the handle will be stored
 */
enum IdeviceErrorCode syslog_relay_connect_tcp(struct TcpProviderHandle *provider,
 ...
 */
enum IdeviceErrorCode syslog_relay_next(struct SyslogRelayClientHandle *client,
                                        char **log_message);
